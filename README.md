...
🧬 I am [Molena](https://thmolena.github.io/molena/). I am a Third-year Applied Mathematics Ph.D. Student at North Carolina State University (Raleigh, North Carolina, USA). I am currently working in Randomized Numerical Linear Algebra for Scientific and High Performance Computing. Specifically, I am developing efficient algorithms for kernel matrix approximation in GPU-Accelerated Computing, and Parallel Computing, including, but not limited to Hierarchical matrices, Low-Rank and Rank-Structured matrices, Hierarchically Off–Diagonal Low-Rank matrices, and Hierarchically Semi-Separable matrices, in addition to the applications to kernel methods in Deep Learning, Machine Learning, and Data Science.
