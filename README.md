...
<li> Randomized Numerical Linear Algebra for Scientific and High Performance Computing, with the focus on efficient algorithms for kernel matrix approximation in GPU-Accelerated Computing, Parallel Computing, including, but not limited to Hierarchical matrices, Low-rank and Rank-structured matrices, Hierarchically Off–Diagonal Low Rank matrices, and Hierarchically Semi-separable matrices, in addition to the applications of kernel methods in Deep Learning, Machine Learning, and Data Science
